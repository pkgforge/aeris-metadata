...
# carrying one is also tried without it. Anything that marks a different build
# of the program, such as -git or -nightly, is deliberately not in here.
PACKAGING_SUFFIXES = ("-bin", "-app", "-deb", "-appimage", "-static")
